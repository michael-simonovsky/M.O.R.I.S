...
String readString;
String code;
String value; // The code value if not raw
...
value1 = strtoul( c,NULL, 16); 
//irsend.sendNEC(value1,32);
//long value2 = code.toInt();
//Serial.println(value2);
//irsend.sendRaw('code', 16,38); //send 0x0 code (8 bits)
//irsend.sendRaw('c', 16,38);
//irsend.sendRaw(value1, 32,38);
//irsend.sendRaw(code, 8,38);
irsend.sendRaw(2991422340,32,38);
irsend.sendRaw(value1, 32,38);
//irsend.sendRaw(value1, 16,38);
//irsend.sendRaw(0x20DF10EF, 32,38);
Serial.println(value1);
Serial.println(value1,16);
Serial.println(value1,10);
Serial.println(value1,32);
      //Serial.println(value1,16);
     //` Serial.println(value1,32);
